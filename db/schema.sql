CREATE DATABASE  IF NOT EXISTS `insurancemanagementdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
--
-- Temporary view structure for view `customer_policy_details`
--

DROP TABLE IF EXISTS `customer_policy_details`;
/*!50001 DROP VIEW IF EXISTS `customer_policy_details`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `customer_policy_details` AS SELECT 
 1 AS `customer_id`,
 1 AS `first_name`,
 1 AS `last_name`,
 1 AS `phone_no`,
...
--
-- Temporary view structure for view `expired_policies`
--

DROP TABLE IF EXISTS `expired_policies`;
/*!50001 DROP VIEW IF EXISTS `expired_policies`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `expired_policies` AS SELECT 
 1 AS `policy_id`,
 1 AS `customer_id`,
 1 AS `policy_type_id`,
 1 AS `start_date`,
...
--
-- Final view structure for view `customer_policy_details`
--
...
/*!50001 VIEW `customer_policy_details` AS select `c`.`customer_id` AS `customer_id`,`c`.`first_name` AS `first_name`,`c`.`last_name` AS `last_name`,`c`.`phone_no` AS `phone_no`,`c`.`dob` AS `dob`,`c`.`address` AS `address`,`p`.`policy_id` AS `policy_id`,`p`.`start_date` AS `start_date`,`p`.`end_date` AS `end_date`,`p`.`coverage_amt` AS `coverage_amt`,`p`.`status` AS `status` from (`customers` `c` join `policy` `p` on((`c`.`customer_id` = `p`.`customer_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `expired_policies`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `expired_policies` AS select `policy`.`policy_id` AS `policy_id`,`policy`.`customer_id` AS `customer_id`,`policy`.`policy_type_id` AS `policy_type_id`,`policy`.`start_date` AS `start_date`,`policy`.`end_date` AS `end_date`,`policy`.`coverage_amt` AS `coverage_amt`,`policy`.`status` AS `status` from `policy` where ((`policy`.`end_date` < curdate()) and (`policy`.`status` <> 'Expired')) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-10-01 11:29:09
